...
BLEBooleanCharacteristic UnlockCharacteristic("19B10001-E8F2-537E-4F6C-D104768A1215", BLEWrite);
...
void loop() {
  ...
  if (MotionBig) {
    PulseBuzzer(1, 0.5, 0.5);  // repetitions, DurationOn , DurationOff, intensity
...
float getRotationData() {
  ...
  float RotationDataerence = currentRotation - previousRotation;                // Calculate the difference in rotation ADD Here for Latitude and longgitude!
